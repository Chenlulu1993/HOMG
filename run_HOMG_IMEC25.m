...
Lulu Chen, Yongqiang Zhao, Jonathan Cheung-Wai Chan, Seong G. Kong. 
...
hog_params.mosaic = load('mosaic_IMEC25.mat'); %the mosaic spectral and spatial correlation matrix
...
params.seq = seq;   
params.mosaic = hog_params.mosaic;
% Run tracker
