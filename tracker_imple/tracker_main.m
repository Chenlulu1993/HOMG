...
while true
    ...
    if seq.frame > 1
        ...
        while iter <= params.refinement_iterations && any(old_pos ~= pos)
            ...
            [xt, img_samples] = extract_features(im, sample_pos, sample_scale, features, global_fparams, feature_info,params.mosaic);
    ...
    sample_pos = round(pos);
    [xl, ~] = extract_features(im, sample_pos, currentScaleFactor, features, global_fparams, feature_info,params.mosaic);
    ...
    if params.vis_res
        ...
        location =  [pos([2]) + target_sz([2])/2,pos([1]) - target_sz([1])/2];
